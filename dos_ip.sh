#!/bin/bash
# Autor: francisco@twpanel.com
# 
# Este script permite levantar dos ip diferente en dos tarjetas de red.
# se asume  que las tarjetas levantan en eth0 y eth1
# se asume que publica es una red e interna es otra red.
TABLA_1="t0"
TABLA_2="t1"
IP_PUBLICA=$(hostname -I | cut -d' ' -f1) #eth0
IP_INTERNA=$(hostname -I | cut -d' ' -f2) #eth1 
echo "Leyendo ..."
...
#Aplicamos route por defualt  t10 y t1
